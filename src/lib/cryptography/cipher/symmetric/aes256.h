...
#ifndef BLRT_LIB_CRYPTOGRAPHY_CIPHER_SYMMETRIC_AES256_H
#define BLRT_LIB_CRYPTOGRAPHY_CIPHER_SYMMETRIC_AES256_H
...
#endif // !BLRT_LIB_CRYPTOGRAPHY_CIPHER_SYMMETRIC_AES256_H
